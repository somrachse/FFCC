        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            ...
            <div className="footer-social">
              <a
                href="https://www.facebook.com/share/1EMMPcRq6a/?mibextid=wwXIfr"
                target="_blank"
              ...
              <a
                href="https://www.youtube.com/@FFCCChurch"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
              >
          ...
          <div>
            ...
            <div className="footer-contact-item">
              ...
              <span>Sen Sok 6, Songkat Khmunh, Khan Sen Sok, Phnom Penh</span>
            </div>
            <a className="footer-contact-item" href="tel:+855967797790">
              <svg viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
              <span>096 779 7790</span>
            </a>
            <a className="footer-contact-item" href="mailto:faithfulfamilyofchristchurch@gmail.com">
              <svg viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
              <span>faithfulfamilyofchristchurch@gmail.com</span>
            </a>
          </div>
        </div>
